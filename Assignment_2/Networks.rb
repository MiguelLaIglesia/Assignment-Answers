...
class Networks
  ...
  # Adds a new member (and its annotations) for an existing network
  ...
  #    It merges members, GO and KEGG annotations of the networks. One of the networks is deleted, the other is the one merged
